      ...
      <Card className="financial-card mb-6 bg-amber-500">
        <CardContent className="p-4">
          <div className="mb-4">
            ...
            {stocks.length === 0 ? <p className="text-aura-secondary-text py-2">
            ...
            {stocks.length < 3 && <div className="relative">
                ...
                <Input placeholder="Search for stocks to compare..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="pl-10 bg-slate-50 rounded-3xl" />
            ...
            {stocks.length === 0 && <div className="mt-3 flex justify-center">
                <Button variant="outline" onClick={() => handleAddStock(mockStocks[0])} className="flex items-center bg-violet-950 hover:bg-violet-800 rounded-3xl">
